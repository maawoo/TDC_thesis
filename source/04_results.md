...
![Roda forest between the cities of Kahla in the northwest and Neustadt an der Orla in the southeast. A forest cover layer is superimposed [@ATKIS2021]. Spatial reference system: GLANCE7 EU grid.](source/figures/04_results_7__roda_aoi.png){#fig:roda_aoi width=100%}
